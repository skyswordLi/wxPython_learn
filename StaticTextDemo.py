...
class StaticTextFrame(wx.Frame):
    def __init__(self):
        ...
        # 指定新字体的静态文本
        my_str = "You can also change the font."
        text = wx.StaticText(panel, -1, my_str, (20, 100))
        font = wx.Font(18, wx.SCRIPT, wx.ITALIC, wx.LIGHT)
        text.SetFont(font)
